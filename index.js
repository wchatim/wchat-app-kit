...
module.exports = { 
    ...
    ScrollableTabView,
    ScrollableTabBar,
    Svg:{Svg,Circle,Ellipse,G,Text:Svg.Text,TSpan,TextPath,Path,Polygon,Polyline,Line,Rect,Use,Image:Svg.Image,Symbol,Defs,LinearGradient,RadialGradient,Stop,ClipPath,Pattern,Mask}
}